...
require('lazy').setup({
  ...
  { 'numToStr/Comment.nvim', opts = {},
    config = function()
      require('Comment').setup()
      vim.keymap.set('n', '<C-c>', require('Comment.api').toggle.linewise.current, { noremap = true, silent = true })
    end
  },
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>b', builtin.builtin, { desc = 'Search Select Telescope' })
      ...
      local function get_visual_selection()
        ...
        vim.cmd('noau normal! "vy"')  -- Yank the selected text to the "v" register
 ...
 --      notify_on_error = false,
      ...
      --   local disable_filetypes = { c = true, cpp = true, perl = true }
      --   return {
      --     timeout_ms = 500,
